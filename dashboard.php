...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="SOLUCIAN IoT">
      ...
      <div class="app-footer">
        <div class="p-2 text-xs">
          <div class="pull-right text-muted py-1">
            &copy; Copyright <strong>SOLUCIAN inc.</strong> <span class="hidden-xs-down">-Build by Luis Rolando Cahuana Leon</span>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                    <!-- esta parte lo explica en la clase 40-->
...
//esta funcion actualiza los datos que estan en el dashboard, actualiza 3 parametros de una sola vez
function update_values(temp1, temp2, volts){
  $("#display_temp1").html(temp1);
  $("#display_temp2").html(temp2);
  $("#display_volt").html(volts);
}
//procesa el mensaje que viene con topico
function process_msg(topic, message){
  // ej: "10,11,12"
  if (topic == "values"){
    var msg = message.toString();
    var sp = msg.split(",");//separa el string de mensaje
    var temp1 = sp[0];
    var temp2 = sp[1];
    var volts = sp[2];
...
function process_led1(){
  if ($('#input_led1').is(":checked")){
    ...
    client.publish('led1', 'on', (error) => {//sobre el topico 'led1' enviar 'on'
...
const WebSocket_URL = 'wss://timbrewifi.ga:8094/mqtt'
...
//en esta funcion recibe los mensajes segun el topico, esto es un listener
