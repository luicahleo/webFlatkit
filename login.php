...
if(isset($_POST['email']) && isset($_POST['password'])) {
  ...
  if ($_POST['email']==""){
    ...
    $users = $result->fetch_all(MYSQLI_ASSOC); //crea un array como resultado
    ...
    if ($count == 1){
      ...
      echo '<meta http-equiv="refresh" content="2; url=dashboard.php">'; //refresca o redireciona la web despues de 2 seg de espera
    }else{
      $msg .= "Acceso denegado!!!";
      $_SESSION['logged'] = false;
    }
