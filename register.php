...
$conn = mysqli_connect("localhost","admin_cursoiot","121212","admin_cursoiot"); //mysqli_connect("ME LLAMO A MI mismo porque esta dentro del servidor","usuario","contrasena","db a la que nos vamos a conectar")
...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="SOLUCIAN">
